...
"\n"
"Options:\n"
"  -m, --main       Include boilerplate main function.\n"
"  -t, --html       Send content-type header (text/html, charset utf-8).\n"
"  -n, --no-comments    Omit begin/end comments in output.\n"
"  -c <comment>, --comment=<comment>    Override default comment (generated by).\n"
"                   Pass an empty string to omit comment header.\n"
"  -a <prefix>, --prepend=<prefix>  String to prepend (default none).\n"
"                   Useful to pass some extra code at the beginning,\n"
"                   eg. (bash): -a $'void toto(const char *titi)\\n{'\n"
"                   or: -a \"$(cat myfile.h myfile.c)\"\n"
"  -z <suffix>, --append=<suffix>   String to append (default none).\n"
"                   Useful to pass some extra code at the end,\n"
"                   eg. (bash): -z $'\\nreturn 0;\\n}'\n"
"  -p <func>, --print=<func>    Override function 'print(x)'.\n"
"                   By default, 'print(x)' is a macro for 'fputs(x, stdout)'.\n"
"  -f <func>, --printf=<func>   Override function 'printf(x, ...)'.\n"
